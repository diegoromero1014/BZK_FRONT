  ...
  render() {
    ...
    return (
        <Col xs={1} sm={1} md={1} lg={1}>
          <button className="btn btn-primary" type="button" title="Ver célula" style={{marginTop: "0px", backgroundColor: "#e79c29", borderRadius: "0px", height:"50%", float:"right"}} onClick={this.openModal}>
            <i className="users outline icon" style={{color: "white",margin:'0em', fontSize : '1.2em'}}></i>
          </button>
