        ...
        <div className="client-card" style={{width:"250px", float:"left"}}>
          <div className="celula-card-top">
            <div className="celula-card-top-left">
              ...
              <div className="celula-name">{position.length > 32 ? position.substring(0, 32) + "..." : position}</div>
              <div className="celula-title">{company.length > 25 ? company.substring(0, 25) + "..." : company}</div>
              <div className="celula-name" style={{marginTop: "5px", fontStyle: "italic"}}>{assistant.length > 30 ? assistant.substring(0, 30) + "..." : assistant}</div>
            </div>
          </div>
