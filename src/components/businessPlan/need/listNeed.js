        ...
        if (needs.size > 0) {
            var data = _.chain(needs.toArray()).map(need => {
                ...
                return _.assign({}, {
                    ...
                    needIdImplementation: needIdImplementation,
                    needTask: needTask,
                    needBenefits: needBenefits,
                    needIdResponsable: needIdResponsable,
                    needResponsable: needResponsable,
                    needDate: needDate,
                    needFormat: needFormat,
                    statusIdNeed: statusIdNeed,
                    descripcionNecesidad: shorterStringValue(descriptionNeedText, 120),
                    'delete': {
