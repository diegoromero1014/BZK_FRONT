...
export const MESSAGE_NEW_COMPONENTS = "Señor usuario, próximamente podrá visualizar en el formulario las siguientes secciones: Objetivos - Estrategias del cliente y Oportunidades - Debilidades.";
