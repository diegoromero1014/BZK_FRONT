...
class Footer extends Component {
    ...
    _clickButtonActiveLogs() {
        let response = prompt("Está es una opción solo para el personal administrativo, por favor ingrese la clave requerida");
    ...
    render() {
        return (
            <footer className="welcome-footer">
              ...
              <Modal isOpen={this.state.modalIsOpen} contentLabel="Logs" onRequestClose={this.closeModal}
