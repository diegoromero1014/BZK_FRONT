                                ...
                                <Row>
                                    ...
                                    <Row style={{ padding: "10px 10px 20px 20px", marginTop: 20, width:'100%' }}>
                                        ...
                                        <Col style={{ marginTop: '-50px' }} xs={12} md={12} lg={12}>
                                            <ElementsComponent schema={schemaObjectivesInterlocutor} placeholder={OBJECTIVES_PLACEHOLDER} messageButton='Agregar' name={OBJECTIVES} max={3} title={'Objetivos del interlocutor'} isEditable={true} singularTitle={'objetivo del interlocutor'}/>
                                        </Col>
                                    </Row>
                                </Row>
                            </div>
