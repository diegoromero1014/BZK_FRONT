...
import {showButtonCloseMenu} from './actions';
...
class MenuListItem extends Component {
    ...
    _handleClickMenuItem() {
        ...
        const {toggleMenu, showButtonCloseMenu, menuReducer} = this.props;
        toggleMenu();
        redirectUrl(linkUrl);
                        ...
                        <Row>
                            <Col xs={12} md={12} lg={12} style={{textAlign: 'center'}}>
                                <i className={iconClassName}
                                   style={{fontSize: "50px", marginTop: marginTop, marginLeft: "10px"}}/>
                            </Col>
                            <Col xs={12} md={12} lg={12} style={{textAlign: 'center'}}>
