...
class AnalyticsTools extends Component {
    constructor(props) {
        super(props);
    ...
    componentWillMount() {
        if (window.localStorage.getItem('sessionToken') === "" || window.localStorage.getItem('sessionToken') === undefined) {
            ...
            updateTitleNavBar(MODULE_ANALYTICS_TOOLS);
        }
    }
                ...
                <Row xs={12} md={12} lg={12} style={{padding: '15px 20px 10px 20px'}}>
                    <Card.Group>
                        ...
                        <Card >
                            ...
                            <Card.Content extra>
                                <Button fluid
                                        onClick={this.downLoadFileUrl.bind(this, analyticsTools.get(PARAMETER_COMEX_URL))}>
                        ...
                        <Card>
                            ...
                            <Card.Content extra>
                                <Button fluid
                                        onClick={this.downLoadFileUrl.bind(this, analyticsTools.get(PARAMETER_FUND_FLOWS_URL))}>
                                    <Icon color="green" name='file excel outline'/>Descargar</Button>
                            </Card.Content>
                        </Card>
                    </Card.Group>
...
export default connect(mapStateToProps, mapDispatchToProps)(AnalyticsTools);
