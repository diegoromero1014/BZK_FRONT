...
import {processRules, checkIsUpdateClient, checkClientName, checkMaxLength,
    ...
    checkOthersEnabledclientOperationsForeignCurrency, checkOthersEnabledOriginResources
...
const fieldsWithRules= {
     ...
     otherOperationsForeign:{rules: [checkFirstCharacter, checkOthersEnabledclientOperationsForeignCurrency, checkOnlyAlphabetical, checkNumberLength(200)]},
     originCityResource:{rules: [checkFirstCharacter, checkIsUpdateClient, checkOnlyAlphabetical, checkNumberLength(20)]},
     detailNonOperatingIncome:{rules: [checkFirstCharacter, checkdetailNonOperatingIncome]},
     ...
     neighborhood:{rules: [checkFirstCharacter, checkClientNeighborhood, checkMaxLength(120)]},
