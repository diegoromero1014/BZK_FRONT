                        ...
                        <Row>
                            <Col xs={12} md={12} lg={12} style={{textAlign: 'center'}}>
                                <i className="big tasks icon"
                                   style={{fontSize: "50px", marginTop: '20px', marginLeft: "10px"}}/>
                            </Col>
                            <Col xs={12} md={12} lg={12} style={{textAlign: 'center'}}>
                        ...
                        <div className="modalBt4-content modal-content">
                            <div className="modalBt4-header modal-header">
                                <h4 className="modal-title" style={{float: 'left', marginBottom: '0px'}}
                                    id="myModalLabel">Mis tareas pendientes</h4>
...
function mapStateToProps({menuReducer}, ownerProps) {
    return {
        menuReducer
    };
}

export default connect(mapStateToProps, mapDispatchToProps)(ButtonComponentMyPending);
