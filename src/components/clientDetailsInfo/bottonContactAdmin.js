...
class BottonContactAdmin extends Component {
  ...
  render() {
    const { errorContact, clientInformacion, message} = this.props;
    ...
    return (
      <div>
        {errorContact ?
          ...
          :
          <span style={{ marginLeft: "20px", marginTop: "10px", color: "green", fontSize: "12pt" }} >{message} <span style={{ cursor: "pointer", textDecoration: "underline" }} onClick={this.openModal}>recuerde revisarlo>>.</span></span>
        }
