                  ...
                  />
                    ...
                    <div>
                        <dt className="business-title"><span
                            style={{paddingLeft: '20px'}}>Clasificación del contacto</span>
                        </dt>
                        <div style={{paddingLeft: '20px', paddingRight: '20px'}}>
                            <Row>
                                <Col xs>
                    ...
                    <dt className="business-title"><span style={{paddingLeft: '20px'}}>Hobbies y deportes</span>
                    </dt>
                    <div style={{paddingLeft: '20px', paddingRight: '20px'}}>
                        <Row>
...
mapStateToProps({contactDetail, selectsReducer, reducerGlobal}, ownerProps) {
    const contact = contactDetail.get('contactDetailList');
    if (contact) {
        return {
            contactDetail,
