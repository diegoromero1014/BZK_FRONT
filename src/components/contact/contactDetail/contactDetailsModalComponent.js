...
class ContactDetailsModalComponent extends Component {
    ...
    componentWillMount() {
        const {
            nonValidateEnter, getMasterDataFields, getContactDetails, contactId, _uploadProvinces,
            contactObject, _uploadCities, showLoading
        } = this.props;
    ...
    _handlerSubmitContact() {
        const {
            ...
            }, error, handleSubmit, selectsReducer, isOpen, changeStateSaveData
        } = this.props;
                ...
                <div className="modalBt4-body modal-body business-content editable-form-content clearfix"
                    ...
                    <div style={{paddingLeft: '20px', paddingRight: '20px'}}>
                        <Row>
                            ...
                            <Col xs={12} sm={12} md={6} lg={4}>
                                ...
                                <button type="button" onClick={this._editContact}
                                    ...
                                    Editar <i className={'icon edit'}></i></button>
                                }
                            </Col>
                        </Row>
                        <Row>
                        ...
                        <Row>
                            ...
                            <Col xs={12} sm={12} md={6} lg={4}>
                                <dt><span>{'Area dependencia ('}</span><span
                                    style={{color: 'red'}}>{'*'}</span><span>{')'}</span></dt>
                                <dd>
                                    <ComboBox
                  ...
                  />
                    ...
                    <dt className="business-title"><span style={{paddingLeft: '20px'}}>Clasificación del contacto</span>
                    </dt>
                    <div style={{paddingLeft: '20px', paddingRight: '20px'}}>
                        <Row>
                            <Col xs>
                                <dt><span>{'Tipo de contacto ('}</span><span
                                    style={{color: 'red'}}>{'*'}</span><span>{')'}</span></dt>
                                <dd>
                                    <ComboBox
