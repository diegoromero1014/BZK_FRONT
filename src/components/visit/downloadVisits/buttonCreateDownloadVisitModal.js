...
import ModalDownloadVisit from './component';
import Modal from 'react-modal';

class ButtonCreateDownloadVisitModal extends Component {
  ...
  closeModal(){
	...
	render() {
		return (
      <div style={{position: 'fixed', border: '1px solid rgb(194, 194, 194)', bottom: '0px', width: '100%', marginBottom: '0px', height: '50px', background: 'rgba(255, 255, 255, 0.74902)'}}>
      ...
      <Modal isOpen={this.state.modalIsOpen} onRequestClose={this.closeModal} className="modalBt4-fade modal fade contact-detail-modal in">
        <div className="modalBt4-dialog modalBt4-lg">
          <div className="modalBt4-content modal-content">
            ...
            <ModalDownloadVisit isOpen={this.closeModal} />
          </div>
        </div>
      </Modal>
      </div>
...
export default ButtonCreateDownloadVisitModal;
