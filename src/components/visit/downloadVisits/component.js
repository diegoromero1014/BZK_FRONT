		...
		return (
			<div>
				<div className="modalBt4-body modal-body business-content editable-form-content clearfix" id="modalComponentScroll">
					<dt className="business-title"><span style={{paddingLeft: '20px'}}>{'En esta sección podrá descargar algunos campos  de los "informes de visita/reunión" del cliente.\n Seleccione los campos que desea descargar a excel:'}</span></dt>
					...
					<dt className="business-title"><span style={{paddingLeft: '20px'}}>{'Adicional a los campos seleccionados, en el excel encontrará los siguiente campos:'}</span></dt>
					<div style={{paddingLeft: '20px', paddingRight: '20px'}}>
						<ul className="ui list">
