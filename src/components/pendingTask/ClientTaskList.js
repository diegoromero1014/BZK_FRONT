...
import { tasksByClientFindServer, clearUserTask, clearUserTaskOrder, limitiInf, changePage, orderColumnUserTask, clearUserTaskPaginator, loadTaskPending,searchTaskPending } from './actions';
...
class ClientTaskList extends Component {
  ...
  componentDidMount() {
    ...
    if (window.localStorage.getItem('sessionTokenFront') === "") {
      ...
      const { dispatchValidatePermissionsByModule, dispatchClearUserTaskOrder, dispatchTasksByClientFindServer, dispatchInitPending, updateCounterPending } = this.props;
