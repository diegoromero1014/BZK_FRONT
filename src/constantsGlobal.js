...
export const REGEX_SIMPLE_XSS_STRING = "/<.*?>|cmd|&#|onabort|onbeforeunload|onerror|onhashchange|onload|onpageshow|onpagehide|onresize|onscroll|onunload|javascript|onmouseover|CMD|ONABORT|ONBEFOREUNLOAD|ONERROR|ONHASHCHANGE|ONLOAD|ONPAGESHOW|ONPAGEHIDE|ONRESIZE|ONSCROLL|ONUNLOAD|JAVASCRIPT|ONMOUSEOVER/g";
